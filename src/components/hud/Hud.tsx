...
const Hud = ({ progressPercent, onReset }: HudProps) => {
    return (
        <header className="fixed top-0 left-0 w-full bg-slate-900/90 border-b border-slate-700 z-50 px-4 py-3 flex justify-between items-center shadow-lg backdrop-blur-sm">
            ...
            <div className="flex items-center gap-4">
                ...
                <button 
                    onClick={onReset} 
                    className="text-xs border border-red-500 text-red-400 hover:bg-red-500/10 px-3 py-1 rounded transition-colors" 
